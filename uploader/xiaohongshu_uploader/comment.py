...
from core.stealth import (  # noqa: E402
    MAC_UA, STEALTH_SCRIPT, LAUNCH_ARGS, ensure_display, find_chrome,
)
from core import human_behavior as hb  # noqa: E402
from uploader.xiaohongshu_uploader.xhs_selectors import find_visible  # noqa: E402
...
COOKIE = str(_Path(__file__).resolve().parent.parent.parent / "cookies" / "xiaohongshu_hermes.json")
...
async def main():
    ...
    async with async_playwright() as p:
        browser = await p.chromium.launch(headless=False, executable_path=find_chrome(), args=LAUNCH_ARGS)
